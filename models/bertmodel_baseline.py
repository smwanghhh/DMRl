...
class CrossMdoalBlock(nn.Module):
    def __init__(self,
        ...
        self.gru_text = nn.GRU(self.dim , self.dim, 3, batch_first=True, bidirectional=True, dropout=0.0)
        self.gru_visual = nn.GRU(self.dim , self.dim, 3, batch_first=True, bidirectional=True, dropout=0.0)
        self.gru_audio = nn.GRU(self.dim , self.dim, 3, batch_first=True, bidirectional=True, dropout=0.0)
    ...
    def forward(self,
        ...
        text_features, visual_features, audio_features = out[:, :50], out[:,50:100], out[:, 100:]
